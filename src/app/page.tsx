  ...
  return (
    <>
      ...
      <div className="theme-switcher">
        ...
        <button className="theme-btn" data-set="elegant" title="Elegant Dark">E</button>
        <button className="theme-btn" data-set="classic" title="Classic Light">C</button>
      </div>
      ...
      <section className="hero" id="hero">
        ...
        <div className="hero-visual reveal">
          <div className="hero-card">
            <div className="hero-card-monogram">KC</div>
            <div className="hero-card-badge badge-1">
              <div className="label">Current Role</div>
              <div className="value">GenAI Dev · PwC</div>
            </div>
      ...
      <section id="experience">
        ...
        <div className="timeline">
          <div className="timeline-item reveal">
            ...
            <div className="timeline-company">PricewaterhouseCoopers (PwC) <span className="loc">· Hyderabad · Hybrid</span></div>
        ...
        <div className="projects-grid">
          <div className="project-card reveal">
            ...
            <div className="project-actions">
              <a href="https://documind-peach.vercel.app" target="_blank" rel="noopener" className="project-link primary">→ Live Demo</a>
      ...
      <section id="education">
        ...
        <p className="section-subtitle reveal">Computer science from Diploma → B.Tech, plus Class 10 fundamentals.</p>
